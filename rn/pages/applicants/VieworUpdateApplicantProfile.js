      ...
      <StatusBar barStyle="dark-content" />
        ...
        <DropDownPicker 
            ...
            items={[
                ...
                {label: 'Intake / Interview / Acceptance', value: 'Intake/Interview/Acceptance'},
                {label: 'Admission', value: 'Admission'},
                {label: 'Settle-in', value: 'Settle-in'},
                {label: 'Case Plan With Case Manager', value: 'Case Plan With Case Manager'},
                {label: 'Employment w/ Career Coach', value: 'Employment w/ Career Coach'},
